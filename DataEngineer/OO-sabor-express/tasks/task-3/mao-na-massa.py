...
# imprimir uma representação em string da pessoa. Implemente também um método de instância chamado aniversario que aumenta a idade da pessoa em um ano.
...
class Pessoa:
    ...
    def saudacao(self):
        if self.profissao:
            return f'Olá sou o {self.nome} e minha profissão (futuro não muito distante) é {self.profissao}'

pessoa = Pessoa('Hedir', 35, 'Engenheiro de dados')
